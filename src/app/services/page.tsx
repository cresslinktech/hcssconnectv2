...
export const metadata: Metadata = {
  title: 'Our Services | HCSS Connect — Domiciliary Care Services London',
...
export default function ServicesPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-[1.05fr_1fr] gap-8 lg:gap-10 items-stretch">
            <FadeIn>
              <div className="py-6 md:py-10">
                <p className="text-xs md:text-sm font-semibold tracking-[0.16em] uppercase text-[#0d9488]">Our Services</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((service, index) => (
              <FadeIn key={service.title} delay={index * 0.1}>
                <div className="h-full rounded-lg border border-[#dcebe9] bg-[#f8fcfb] p-6 transition-all duration-300 hover:border-[#b9dbd7] group">
                  <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-md bg-[#eaf6f4] text-[#0d9488]">
                    {iconMap[service.icon]}
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3">{service.title}</h3>
                  <p className="text-base font-medium text-slate-800 leading-7 mb-5">{service.description}</p>
                  <Link href={service.href} className="inline-flex items-center text-base font-semibold text-[#0d9488]">
      ...
      <section className="bg-white pb-16">
        <div className="container-wide">
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-8 items-center">
            <FadeIn>
              <div>
                <span className="inline-block text-[#0d9488] font-semibold text-sm uppercase tracking-wider mb-4">Our Process</span>
            ...
            <FadeIn direction="right" delay={0.2}>
              <div className="relative min-h-[360px] overflow-hidden rounded-md border border-[#dcebe9]">
                <Image
      ...
      <section className="bg-[#e7f3f2] py-14">
        <div className="container-wide">
          <FadeIn>
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="inline-block text-[#0d9488] font-semibold text-sm uppercase tracking-wider mb-4">Specialist Services</span>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <FadeIn delay={0.1}>
              <Link href="/services/complex-care" className="group block rounded-lg border border-[#cde2df] bg-white p-8 hover:border-[#9fc7c2] transition-all duration-300">
                <Activity className="w-10 h-10 text-[#0d9488] mb-4" />
                ...
                <span className="inline-flex items-center text-[#0d9488] text-base font-semibold group-hover:gap-2 transition-all">
                  Learn more <ArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                </span>
              </Link>
            </FadeIn>
            <FadeIn delay={0.2}>
              <Link href="/services/addiction-recovery" className="group block rounded-lg border border-[#cde2df] bg-white p-8 hover:border-[#9fc7c2] transition-all duration-300">
                <Shield className="w-10 h-10 text-[#0d9488] mb-4" />
