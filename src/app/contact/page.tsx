          ...
          <div className="grid lg:grid-cols-[1.05fr_1fr] gap-8 lg:gap-10 items-stretch">
            <FadeIn>
              <div className="py-6 md:py-10">
                <p className="text-xs md:text-sm font-semibold tracking-[0.16em] uppercase text-[#0d9488]">Contact Us</p>
          ...
          <div className="grid lg:grid-cols-5 gap-10">
              ...
              <FadeIn>
                ...
                <div className="space-y-6 mb-10">
                  <a href={`tel:${SITE_CONFIG.phone.replace(/\s/g, '')}`} className="flex items-start gap-4 group">
                    <div className="w-12 h-12 bg-[#eaf6f4] rounded-md flex items-center justify-center text-[#0d9488] flex-shrink-0 transition-all">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#eaf6f4] rounded-md flex items-center justify-center text-[#0d9488] flex-shrink-0">
                ...
                {/* Map placeholder */}
                <div className="rounded-md overflow-hidden aspect-[4/3] border border-[#dcebe9] bg-[#f8fcfb] flex items-center justify-center">
                  <div className="text-center p-8">
                    <MapPin className="w-12 h-12 mx-auto mb-3 text-[#0d9488]" />
            ...
            <div className="lg:col-span-3">
              <FadeIn direction="right" delay={0.2}>
                ...
                {submitted ? (
                  <div className="bg-[#f8fcfb] rounded-xl border border-[#dcebe9] p-12 text-center">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 rounded-xl border border-[#dcebe9] bg-[#f8fcfb] p-6 md:p-8">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          type="text"
                          required
                          className="w-full px-4 py-3 rounded-md border border-[#cfe2df] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition-all outline-none text-base bg-white"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full px-4 py-3 rounded-md border border-[#cfe2df] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition-all outline-none resize-none text-base bg-white"
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <label htmlFor="contact-consent" className="text-base font-medium text-slate-800">
                        I agree to HCSS Connect processing my personal data in accordance with their 
                        Privacy Policy. <span className="text-red-500">*</span>
                      </label>
                    </div>

                    <button type="submit" className="inline-flex items-center rounded-md bg-[#0d9488] px-6 py-3 text-base font-semibold text-white hover:bg-[#0b7f75] transition-colors">
